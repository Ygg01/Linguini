...
namespace Linguini.Syntax.Ast
{
    ...
    public readonly struct CallArguments : IEquatable<CallArguments>
    {
        ...
        /// Each positional argument is an instance of <see cref="IInlineExpression"/>, like a <see cref="NumberLiteral"/> or <see cref="TextLiteral"/>
        /// </summary>
    ...
    public class InlineExpressionBuilder
    {
        ...
        /// </summary>
        /// <param name="numberLiteral">The numeric value of type <see cref="double"/> to create a <see cref="NumberLiteral"/> from.</param>
        /// <returns>An instance of <see cref="InlineExpressionBuilder"/> initialized with the created <see cref="NumberLiteral"/>.</returns>
        ...
        /// </summary>
        /// <param name="numberLiteral">The numeric value of type <see cref="float"/> to create a <see cref="NumberLiteral"/> from.</param>
        /// <returns>An instance of <see cref="InlineExpressionBuilder"/> initialized with the created <see cref="NumberLiteral"/>.</returns>
        ...
        /// <returns>An instance of <see cref="InlineExpressionBuilder"/> initialized with the specified <see cref="PlaceableBuilder"/>.</returns>
        ...
        /// <summary>
        /// Creates an instance of <see cref="InlineExpressionBuilder"/> containing a <see cref="TextLiteral"/> with the given text.
        /// </summary>
